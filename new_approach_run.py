...
def run(test_params):
    ...
    cmd = f"nohup python3 -u new_approach_main.py \
...
def get_log_name(test_params):
    ...
    os.makedirs(f"New_approach/logs/with_all_evaluation_matrix_main{test_params['query_results_dir']}_logs", exist_ok=True)
    ...
    return f"New_approach/logs/with_all_evaluation_matrix_main{test_params['query_results_dir']}_logs/{log_name}.txt", log_name
