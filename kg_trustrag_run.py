...
def run(test_params):
    ...
    cmd = f"nohup python3 -u kg_trustrag.py \
...
def get_log_name(test_params):
    ...
    os.makedirs(f"kg_trustrag/20k/{test_params['query_results_dir']}_logs", exist_ok=True)
    ...
    return f"kg_trustrag/20k/{test_params['query_results_dir']}_logs/{log_name}.txt", log_name
