...
def get_log_name(test_params):
    ...
    os.makedirs(f"/mnt/SAS_A/srushti_thesis/Final_Code/PoisonedRAG/duplicate_filtering/logs/{test_params['query_results_dir']}_logs", exist_ok=True)
    ...
    return f"/mnt/SAS_A/srushti_thesis/Final_Code/PoisonedRAG/duplicate_filtering/logs/{test_params['query_results_dir']}_logs/{log_name}.txt", log_name
