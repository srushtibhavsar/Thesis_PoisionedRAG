...
def get_log_name(test_params):
    ...
    os.makedirs(f"/mnt/SAS_A/srushti_thesis/Final_Code/PoisonedRAG/paraphrasing/logs_llama/{test_params['query_results_dir']}_logs", exist_ok=True)
    ...
    return f"/mnt/SAS_A/srushti_thesis/Final_Code/PoisonedRAG/paraphrasing/logs_llama/{test_params['query_results_dir']}_logs/{log_name}.txt", log_name
